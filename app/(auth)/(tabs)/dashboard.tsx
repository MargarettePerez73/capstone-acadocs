...
const QUICK_CARDS: QuickCard[] = [
  ...
  {
    label: 'Submit DLL',
    subtitle: 'Upload your daily lesson log',
  ...
  {
    label: 'Lesson Plans',
    subtitle: 'Upload & manage lesson plans',
    icon: 'book-outline',
    route: '/(auth)/(tabs)/submissions',
    accent: '#1565C0',
    roles: ['teacher'],
  ...
  {
    label: 'Enter MPS',
    subtitle: 'Encode quarterly scores',
  ...
  {
    label: 'Audit Room',
    subtitle: 'Update classroom property',
    icon: 'clipboard-outline',
    route: '/(auth)/(tabs)/room-audit',
    accent: '#6A1B9A',
    roles: ['teacher'],
  },
  ...
  // ── Principal ──
  {
    ...
    subtitle: 'Track DLL & lesson plan compliance',
    icon: 'clipboard-outline',
    route: '/(auth)/(tabs)/submissions',
    accent: Colors.maroon.primary,
    roles: ['principal'],
  ...
  {
    label: 'MPS Overview',
    subtitle: 'School-wide performance analytics',
  ...
  },
  {
    ...
    subtitle: 'Export PDF & Excel summaries',
  ...
  },
  {
    ...
    subtitle: 'Send notice to all users',
  ...
  },
  {
    ...
    subtitle: 'Message teachers & personnel',
    icon: 'people-outline',
  ...
  {
    label: 'Time Records',
    subtitle: "Log today's time-in data",
    icon: 'time-outline',
    route: '/(auth)/(tabs)/time-records',
    accent: Colors.maroon.primary,
    roles: ['adas'],
  },
  {
    label: 'DepEd Documents',
    subtitle: 'Submit required DepEd reports',
    icon: 'document-text-outline',
    route: '/(auth)/(tabs)/deped-docs',
    accent: '#1565C0',
    roles: ['adas'],
  },
  {
    label: 'Room Audit',
    subtitle: 'Check classroom properties',
  ...
  {
    label: 'Send Report to Principal',
    subtitle: 'Forward daily summary',
    icon: 'send-outline',
    route: '/(auth)/(tabs)/chat',
    accent: '#6A1B9A',
    roles: ['adas'],
  ...
  // ── Secretary ──
  {
    label: 'Manage Doc Links',
    subtitle: 'Share DepEd portal links',
    icon: 'link-outline',
    route: '/(auth)/(tabs)/notices',
    accent: Colors.maroon.primary,
    roles: ['secretary'],
  },
  {
    label: 'View Announcements',
    subtitle: 'Read school notices',
